...
export default async function handler(req, res) {
  try {
    ...
    if (orderData.orderState.length == 0) {
    ...
    EmailSender(
      orderData.email,
      `<h1>Your Order is confirm by seller go and check the status of your order <a href="${process.env.ADMIN_URL}/myorders">Check</a></h1>`,
